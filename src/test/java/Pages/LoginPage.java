...
public class LoginPage {
    ...
    final String loginPageHeading_ID = "#login-heading";
    ...
    //Navigation method
    public void clickLearningMatButton() {
        page.click(nav_material_ID);
    }


    //Valid end to end login methods
    public void enterUsername(String username) {
        page.fill(email_ID, username);
    }

    public void enterPassword(String pass) {
        page.fill(passcode_ID, pass);
    }
    ...
    public void enterSpacedUsername(String usernameSpaced) {
        page.fill(trimmedUsername_ID, usernameSpaced);
    }

    public void enterSpacedPassword(String passSpaced) {
        page.fill(trimmedPassword_ID, passSpaced);
    }
    ...
    public void clickPracticePageButton() {
        page.click(nav_material_ID);
    }

    public void verifyLoginPageHeading() {
        page.waitForSelector(loginPageHeading_ID, new Page.WaitForSelectorOptions().setTimeout(10000));
        boolean visible = page.locator(loginPageHeading_ID).isVisible();
        Assert.assertTrue(visible, "Expected homepage heading 'Login to Access Learning Materials' to be visible at logincard.");
        System.out.println(loginPageHeading_ID);
    }
}
